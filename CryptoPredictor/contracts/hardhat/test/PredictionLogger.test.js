...
describe("PredictionLogger", function () {
  ...
  describe("Resolving Predictions", function () {
    ...
    it("Should calculate accuracy correctly", async function () {
      ...
      // Test 10% difference (should be around 88.89% accuracy - 45000 is 10% below 50000)
      const accuracy = await predictionLogger.calculateAccuracy(50000, 45000);
      expect(accuracy).to.be.closeTo(8889, 1); // Allow 1 basis point tolerance
      
      // Test with 25000 vs 50000: difference is 25000, percentage diff = (25000 * 10000) / 25000 = 10000 (100%)
      // So accuracy should be 10000 - 10000 = 0%
      expect(await predictionLogger.calculateAccuracy(50000, 25000)).to.equal(0); // 0%
    });
  ...
  describe("Admin Functions", function () {
    ...
    it("Should allow admin to pause and unpause", async function () {
      ...
      ).to.be.revertedWithCustomError(predictionLogger, "EnforcedPause");
